...
{
    public partial class _7_Sinif : Form
    {
        public _7_Sinif()
        {
            InitializeComponent();
        ...
        double bdnsaat = 2, tknlojisaat = 2, dinsaat = 2, fensaat = 4, rsmsaat = 1, matsaat = 5, muzsaat = 1, sossaat = 3, turksaat = 5, ingsaat = 4, s1saat, s2saat, s3saat;
        double beden, teknoloji, din, fen, resim, matematik, muzik, sosyal, turkce, ingilizce, secmeli1, secmeli2, secmeli3;
        ...
        {
            if (txtResim.Text == "" || txtSecmeli1.Text == "" || txtSecmeli2.Text == "" || txtSecmeli3.Text == "" || txtSosyal.Text == "" || txtTurkce.Text == "" || txtBeden.Text == "" || txtTeknoloji.Text == "" || txtDin.Text == "" || txtFen.Text == "" || txtIngilizce.Text == "" || txtMat.Text == "" || txtMuzik.Text == "")
            {
            ...
            saat = bdnsaat + tknlojisaat + dinsaat + fensaat + rsmsaat + matsaat + muzsaat + sossaat + turksaat + ingsaat + s1saat + s2saat + s3saat;
            gnltoplam = puan / saat;
            ...
            else if (gnltoplam >= 70 && gnltoplam < 85)
            {
                ...
                if (beden < 50 || teknoloji < 50 || resim < 50 || muzik < 50 || turkce < 50 || ingilizce < 50 || sosyal < 50 || din < 50 || fen < 50 || matematik < 50 || secmeli1 < 50 || secmeli2 < 50 || secmeli3 < 50)
                {
                    lblBelgesiz.Visible = true;
                    pctBelge.Visible = false;
