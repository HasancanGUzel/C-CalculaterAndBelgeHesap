...
{
    public partial class _5_ImamHatip : Form
    {
        public _5_ImamHatip()
        {
            InitializeComponent();
        ...
        double bdnsaat = 2, blsmsaat = 2, dinsaat = 2, fensaat = 4, rsmsaat = 1, matsaat = 5, muzsaat = 1, sossaat = 3, turksaat = 6, ingsaat = 3, arpcasaat = 2, kuransaat = 2, siyersaat = 2, s1saat;
        double beden, bilisim, din, fen, resim, matematik, muzik, sosyal, turkce, ingilizce, arapca, siyer, kuran, secmeli1;
        double ort1, ort2, ort3, ort4, ort5, ort6, ort7, ort8, ort9, ort10, ort11, ort12, ort13, ort14;
        double saat, puan, gnltoplam;

        private void btnHesapla_Click(object sender, EventArgs e)
        {
            if (txtKuran.Text == "" || txtResim.Text == "" || txtSecmeli1.Text == "" || txtArapca.Text == "" || txtSiyer.Text == "" || txtSosyal.Text == "" || txtTurkce.Text == "" || txtBeden.Text == "" || txtBilisim.Text == "" || txtDin.Text == "" || txtFen.Text == "" || txtIngilizce.Text == "" || txtMat.Text == "" || txtMuzik.Text == "")
            {
            ...
            else
            {
                ...
                saat = bdnsaat + blsmsaat + dinsaat + fensaat + rsmsaat + matsaat + muzsaat + sossaat + turksaat + ingsaat + s1saat + kuransaat + siyersaat + arpcasaat;
                gnltoplam = puan / saat;
                ...
                else if (gnltoplam >= 70 && gnltoplam < 85)
                {
                    ...
                    lblBelgesiz.Visible = false;
                    if (beden < 50 || bilisim < 50 || din < 50 || fen < 50 || resim < 50 || muzik < 50 || matematik < 50 || sosyal < 50 || turkce < 50 || ingilizce < 50 || secmeli1 < 50 || arapca < 50 || siyer < 50 || kuran < 50)
                    {
                        lblBelgesiz.Visible = true;
                        pctBelge.Visible = false;
