...
{
    public partial class _7_ImamHatip : Form
    {
        public _7_ImamHatip()
        {
            InitializeComponent();
        ...
        double bdnsaat = 1, teksaat = 2, dinsaat = 2, fensaat = 4, rsmsaat = 1, matsaat = 5, muzsaat = 1, sossaat = 3, turksaat = 5, ingsaat = 4, arpcasaat = 2, kuransaat = 2, siyersaat = 2, diniBilsaat = 1, s1saat;
        double beden, teknoloji, din, fen, resim, matematik, muzik, sosyal, turkce, ingilizce, arapca, siyer, kuran, dinibilgiler, secmeli1;
        ...
        {
            if (txtTemelDini.Text == "" || txtKuran.Text == "" || txtResim.Text == "" || txtSecmeli1.Text == "" || txtArapca.Text == "" || txtSiyer.Text == "" || txtSosyal.Text == "" || txtTurkce.Text == "" || txtBeden.Text == "" || txtTeknoloji.Text == "" || txtDin.Text == "" || txtFen.Text == "" || txtIngilizce.Text == "" || txtMat.Text == "" || txtMuzik.Text == "")
            {
            ...
            else
            {
                ...
                saat = bdnsaat + teksaat + dinsaat + fensaat + rsmsaat + matsaat + muzsaat + sossaat + turksaat + ingsaat + s1saat + kuransaat + siyersaat + arpcasaat + diniBilsaat;
                gnltoplam = puan / saat;
                ...
                else if (gnltoplam >= 70 && gnltoplam < 85)
                {
                    ...
                    lblBelgesiz.Visible = false;
                    if (dinibilgiler < 50 || beden < 50 || teknoloji < 50 || din < 50 || fen < 50 || resim < 50 || muzik < 50 || matematik < 50 || sosyal < 50 || turkce < 50 || ingilizce < 50 || secmeli1 < 50 || arapca < 50 || siyer < 50 || kuran < 50)
                    {
                        lblBelgesiz.Visible = true;
                        pctBelge.Visible = false;
